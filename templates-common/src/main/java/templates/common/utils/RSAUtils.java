...
public class RSAUtils {
    ...
    public static byte [] sign(byte [] content, byte [] privateKey) throws NoSuchAlgorithmException, InvalidKeySpecException, InvalidKeyException, SignatureException {
    ...
    public static boolean verify(byte [] content, byte [] sign, byte [] publicKey) throws NoSuchAlgorithmException, InvalidKeySpecException, InvalidKeyException, SignatureException {
        KeyFactory keyFactory = KeyFactory.getInstance("RSA");
    ...
    public static String decryptByPrivateKey(String base64Text, String privateKey) throws Exception {
        byte[] bytes = Base64Util.decode(base64Text);
